...
public interface BailiffInterface
         ...
         *                                            the method has a signature without
         *                                            arguments the value of args
         *                                            should be an empty array. Setting
         *                                            args to null will not work.
         * @exception java.rmi.RemoteException        Thrown if there is an RMI problem.
        ...
        // this method returns the containsIt predicate
